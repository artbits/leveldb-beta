        ...
        implements SeekingIterable<InternalKey, Slice>
{
    ...
    private final ReentrantLock getCompactionLevelLock = new ReentrantLock();
    private final ReentrantLock setCompactionLevelLock = new ReentrantLock();
    private final ReentrantLock getCompactionScoreLock = new ReentrantLock();
    private final ReentrantLock setCompactionScoreLock = new ReentrantLock();
    ...
    public int getCompactionLevel() {
        try {
            getCompactionLevelLock.lock();
            return compactionLevel;
        } finally {
            getCompactionLevelLock.unlock();
        }
    }
    ...
    {
        try {
            setCompactionLevelLock.lock();
            this.compactionLevel = compactionLevel;
        } finally {
            setCompactionLevelLock.unlock();
        }
    }
    ...
    {
        try {
            getCompactionScoreLock.lock();
            return compactionScore;
        } finally {
            getCompactionScoreLock.unlock();
        }
    }
    ...
    {
        try {
            setCompactionScoreLock.lock();
            this.compactionScore = compactionScore;
        } finally {
            setCompactionScoreLock.unlock();
        }
    }
